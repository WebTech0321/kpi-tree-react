...
class VueTree extends Component {
  ...
  setScale(scaleNum) {
    ...
    this.domContainer.current.style.transform =
  ...
  enableDrag() {
    ...
    container.onmousemove = (event) => {
      ...
      let newX =
        Math.floor((event.clientX - startX) / this.state.currentScale) +
        originOffsetX
      let newY =
        Math.floor((event.clientY - startY) / this.state.currentScale) +
        originOffsetY
    ...
    const {nodeDataList} = this.state
      ...
      return (         
        <div className="tree-container" ref={this.container}>
          <svg className="svg vue-tree" ref={this.svg} style={this.initialTransformStyle()}></svg>
                ...
                >
                  <div className="node-item">
                      ...
                      <div className="node-details">
                          <div className={"node-value node-details-item " + node.data.value.color}>
                              {node.data.value.amount}
                          </div>
                          <div className="node-delta node-details-item">
                              <FontAwesome className={node.data.delta.color} name={this.deltaIcon(node.data.delta.color)} />
